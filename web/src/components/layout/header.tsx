...
import { Home, Search, Mail, Bell, Sun, Moon } from "lucide-react";
    ...
    <header className="flex items-center justify-between px-8 py-4 bg-app-surface border-b border-app-surface shadow-sm rounded-t-[32px] mx-4 mt-4">
      ...
      <div className="flex items-center gap-2">
        <span className="font-semibold text-xl tracking-tight text-app-text">
          Dnn Project <span className="text-orange-500 text-4xl">.</span>
        </span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="w-10 h-10 rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center bg-white dark:bg-[#2d2d2d] text-app-text hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
        ...
        <button className="w-10 h-10 rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center bg-white dark:bg-[#2d2d2d] text-app-text hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
